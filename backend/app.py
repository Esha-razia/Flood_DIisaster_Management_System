...
class CompatibleCursor:
    ...
    def execute(self, query, params=None):
        ...
        try:
            ...
            is_connection_error = self.db_type == "postgresql" and (
                "connection" in str(e).lower() or "closed" in str(e).lower() or "server" in str(e).lower()
            )
            if is_connection_error and self.parent_connection is not None:
                try:
