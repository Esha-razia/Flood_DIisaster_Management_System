              ...
              {donationStatus === "done" ? (
                ...
                <form onSubmit={handleDonationSubmit} className="space-y-3">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
                    <input required placeholder={t("itemExamplePh")} value={donationForm.item} onChange={(e) => setDonationForm((p) => ({ ...p, item: e.target.value }))} className="field-input rounded-2xl sm:col-span-2" />
